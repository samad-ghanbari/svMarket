...
>
	<div class="mr-auto ml-4 flex h-10 w-[140px] items-center justify-start">
		...
		<a id="shoppingBtn" class=" mx-4 hidden h-6 w-6 md:block" href="/">
		...
		<button id="profileBtn" class=" hidden h-6 w-6 border-0 bg-transparent md:block">
			...
			<div class="mb-1 h-auto w-52">
				<Listgroup active class="w-full">
					...
					>
						...
						<ArrowLeftOnRectangleIcon class="mr-2 inline h-5 w-5 text-right" />
					</ListgroupItem>
				</Listgroup>
			</div>
		</Popover>
